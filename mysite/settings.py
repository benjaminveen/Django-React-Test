...
SECRET_KEY = '6^6zaj26!^aibl1af1hir*58ll+p@ktzl3q8+lff+q7d%f9)*d'
...
PIPELINE_COMPRESSOR = 'pipeline.compressors.NoopCompressor'

PIPELINE_COMPRESSOR = 'pipeline.compressors.uglifyjs.UglifyJSCompressor'
